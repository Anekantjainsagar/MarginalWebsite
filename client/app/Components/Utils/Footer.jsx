...
const Footer = () => {
  return (
    <div className="bg-gradient-to-tr from-black via-[#003B4D] to-black pt-[5vw] px-[5vw] text-white">
      <div className="grid grid-cols-4 w-full">
        <div>
          <Image
            ...
            className="w-5/12"
          />
          <p className="text-[#F3F3F3]/80 mt-2 w-8/12">
        ...
        <div className="w-9/12">
          ...
          <div className="my-2.5 gap-x-4 flex items-center">
            <svg
          ...
          <div className="my-3 gap-x-4 flex items-start">
            <svg
      ...
      <div className="pb-10 flex items-center gap-x-4 justify-center">
        {[
          "/icons/whatsapp.png",
          "/icons/instagram.png",
          "/icons/facebook.png",
          ...
          return (
            <Image
              key={i}
              alt={e?.src}
              className="p-1.5 w-12 object-contain aspect-square bg-white rounded-full"
              src={e}
              width={1000}
              height={1000}
            />
